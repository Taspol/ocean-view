...
const STORY_STEPS: StoryStep[] = [
  {
    ...
    title: 'See ocean conditions instantly',
    body: 'Live weather overlays, swell, and zone confidence combine into one command view for faster daily decisions.',
    accent: 'from-cyan-400/60 to-blue-500/60',
    metricA: 'Custom zones tracked',
    metricB: 'Realtime layer updates',
    screenshot: '/ui_features/1.PNG',
  },
  {
    id: 'alerts',
    eyebrow: 'Safety Layer',
    title: 'Catch risk before it escalates',
    body: 'Marine alerts are prioritized and geo-tagged so captains can respond quickly and avoid operational blind spots.',
    accent: 'from-amber-400/60 to-orange-500/60',
    metricA: 'Critical alerts first',
    metricB: 'Route-aware warnings',
    screenshot: '/ui_features/2.PNG',
  },
  {
    id: 'analytics',
    eyebrow: 'Performance Intelligence',
    title: 'Analyze patterns that improve yield',
    body: 'Track productivity trends by route, weather window, and zone quality to optimize each trip.',
    accent: 'from-emerald-400/60 to-teal-500/60',
    metricA: 'Trip trend analysis',
    metricB: 'Zone score history',
    screenshot: '/ui_features/3.PNG',
  },
  {
    id: 'team',
    eyebrow: 'Connected Crew',
    title: 'Coordinate through LINE and web',
    body: 'Keep shore teams and vessels aligned with shared updates, alert handoffs, and streamlined communication.',
    accent: 'from-violet-400/60 to-indigo-500/60',
    metricA: 'Team-ready updates',
    metricB: 'Faster handoffs',
